...
const BlogCard = ({ id, title, img }) => {
	...
	return (
		<div className="w-100 perspetive flex items-center justify-center transform hover:scale-105 lg:hover:scale-110 transition ease-out duration-300 hover:border rounded-[24px] shadow-[0_35px_60px_-15px_rgba(0,0,0,0.3)] shadow-cyan-500/25 hover:shadow-cyan-500/50 hover:border-[#00F6FF] ">
